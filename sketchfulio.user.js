// ==UserScript==
// @name         Sketchful.io AUTO DRAW - Sketchfulio Hacks - Best Sketchful Cheat 2019 to 2020
// @description  Sketchfulio Mods Features: Guess Helper, Fast Draw, Auto Draw, Auto Guess, FPS, Adblock
// @namespace    iomods.org
// @author       iomods.org
// @version      2.0
// @require      http://code.jquery.com/jquery-3.3.1.min.js
// @updateURL    https://iomods.org/mods/sketchfulio.user.js
// @downloadURL  https://iomods.org/mods/sketchfulio.user.js
// @match        *://sketchful.io/*
// @match        *iogames.space/*
// @match        *titotu.io/*
// @match        *io-games.io/*
...
ministyler = "color:white;font-size:10px;padding:1px;text-decoration:none;";
if(colorize == true){ministyler = "color:yellow;font-size:10px;padding:1px;text-decoration:none;";}
if(colorizer == true){ministyler = "color:darkorange;font-size:10px;padding:1px;text-decoration:none;";}
...
//genel isimlendirme ve ayarlar
 this.st = {
     ...
     f3: "Rainbow BG",
     f4: "Change BG",
     string: "<a style=\"padding-right: 0px;\"></a> <font color=\"black\">—</font> <a style=\"padding-left: 0px;\"></a>",
     bp: "padding-left: 1px;",
	 os: "font-weight:bold;color:black;font-size:14px;text-decoration:none;",
     os2: "color:black;font-size:11px;text-decoration:none;",
     formstyle: "border:2px solid black;border-radius:20px;background-color: rgba(245, 245, 245, 1.0);",
     ...
     liststyler: "color:white;background-color: black;padding:0px;border-style:double;-webkit-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);-moz-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);",
     imagelist: '<a href="https://www.youtube.com/c/pignuts" style="pointer-events: all;" target="_blank"><img src="https://iomods.org/mods/youtube.jpg" width="160px" height="40px"></a><a href="https://facebook.com/slitherecom" target="_blank"><img src="https://iomods.org/mods/facebook.jpg" width="160px" height="40px"></a></br>'
 };

//degisenkisimlar
$('#avatarSelector').append('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('#moneySquare').html('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('#newsContent').prepend('<div class="list1"></div>');

//general
$('.option1').html('<a style="'+this.st.os+'" href="'+links[0]+'" target="blank">'+this.st.f1+'</a> <input type=\'checkbox\' class="fps" onchange="window.open(\''+links[0]+'\', \'_blank\', \''+values[0]+'\');" checked>'+this.st.string+'<a style="'+this.st.os+'" href="'+links[1]+'" target="blank">'+fts[0]+'</a> <input type=\'checkbox\' onchange="window.open(\''+links[1]+'\', \'_blank\', \''+values[1]+'\');"><div class="option2"></div>');
$('.option1').on('click', '.fps', function() { hideandseek(); });
$('.option2').html('<a style="'+this.st.os+'" href="'+links[2]+'" target="blank">'+fts[1]+'</a> <input type=\'checkbox\' onchange="window.open(\''+links[2]+'\', \'_blank\', \''+values[0]+'\');">'+this.st.string+'<a style="'+this.st.os+'" href="'+links[3]+'" target="blank">'+fts[2]+'</a> <input type=\'checkbox\' onchange="window.open(\''+links[3]+'\', \'_blank\', \''+values[1]+'\');"><div class="option3"></div>');
