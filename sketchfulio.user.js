...
// @updateURL    https://io-mods.com/mods/sketchfulio.user.js
// @downloadURL  https://io-mods.com/mods/sketchfulio.user.js
// @grant        GM_setValue
// @grant        GM_getValue
// @match        *://sketchful.io/*
// @match        *iogames.space/*
...
$('.columnRight').append('<div style="'+this.st.fpsstyle+'" id="fpsx" class="fpsx"></div>');
$('.menuColumn').first().next().html('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('#moneyTopGame').html('<div class="list1"></div>');
$('#moneyBottom').html('<div class="list1"></div>');
$("#moneyTopGame").css({"width": "100%"});
$("#moneyBottom").css({"width": "100%"});
...
document.getElementById("news").prepend(styleSelect);
...
document.getElementById("news").prepend(stylerSelect);
...
function hideandseek() {
  ...
  var xy = document.getElementById("fpsx");
